            ...
            <div class="info" cols="6">
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        <label>Nom</label>
                        <input type="text" class="form-control"  v-model:value="this.user().lastname" placeholder="this.user().lastname">
                    </div>
                    <div class="form-group">
                        <label>Prénom</label>
                        <input type="text" class="form-control" v-model:value="this.user().firstname" placeholder="">
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" v-model:value="this.user().email"  placeholder="">
                    </div>
                    <div class="form-group">
                        <label>Adresse</label>
                        <input type="text" class="form-control" v-model:value="this.user().adresse"  placeholder="">
                    </div>
                    <div class="form-group">
                        <label>Numéro de téléphone</label>
                        <input type="text" class="form-control" v-model:value="this.user().tel"  placeholder="">
                    </div>
